  ...
  return (
    <div className="container text-center mx-auto px-4 py-12">
      ...
      {condition === 'true' ? (
        ...
        <>
          <h4 className="text-[16px] sm:text-[18px] md:text-[20px] font-bold mb-4 text-[#737373]">Featured Products</h4>
          <h3 className="font-[700] text-[20px] sm:text-[22px] md:text-[24px] leading-[28px] sm:leading-[30px] md:leading-[32px] tracking-[0.1px] text-center text-[#252B42] mb-4">BEST SELLER PRODUCTS</h3>
          <p className="mt-[-8px] sm:mt-[-9px] md:mt-[-10px] mb-6 sm:mb-7 md:mb-8 text-[#737373]">Problems trying to resolve the conflict between </p>
          </>
      )}
